#!/usr/bin/env bash
#DSUB -n predict_nnunet_2d_seed20260520
#DSUB -N 1
#DSUB -A root.hzau
#DSUB -R "cpu=8;mem=48000;gpu=1"
#DSUB -pn '!whshare-agent-174'
#DSUB -oo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/predict/predict_nnunet_2d_seed20260520.out
#DSUB -eo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/predict/predict_nnunet_2d_seed20260520.err
set -euo pipefail
...
RUN_DIR=/home/share/hzau/home/liuyangfan/swine-CT-article/data/nnunetv1/v1_comparison_2d_root/seed20260520/runs/nnunet_2d__seed20260520
LAYOUT=/home/share/hzau/home/liuyangfan/swine-CT-article/data/nnunetv1/v1_comparison_2d_nnunet_layout/seed20260520
...
OUT=/home/share/hzau/home/liuyangfan/swine-CT-article/data/nnunetv1/v1_comparison_predictions/nnunet_2d__seed20260520
mkdir -p "${OUT}"
echo "=== predict nnunet_2d seed=20260520 (native nnUNet_predict, TTA off, overlap 0.5) ==="
nnUNet_predict -i "${INPUT}" -o "${OUT}" -t 601 -tr nnUNetTrainerV2 -m 2d -f 0 \
    --disable_tta --step_size 0.5
echo "=== predict_nnunet_2d_seed20260520 DONE (exit $?) ==="
