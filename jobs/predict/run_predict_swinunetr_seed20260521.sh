#!/usr/bin/env bash
#DSUB -n predict_swinunetr_seed20260521
#DSUB -N 1
#DSUB -A root.hzau
#DSUB -R "cpu=8;mem=48000;gpu=1"
#DSUB -pn '!whshare-agent-174'
#DSUB -oo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/predict/predict_swinunetr_seed20260521.out
#DSUB -eo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/predict/predict_swinunetr_seed20260521.err
set -euo pipefail
...
CKPT=/home/share/hzau/home/liuyangfan/swine-CT-article/data/nnunetv1/v1_comparison/swinunetr__seed20260521/fold_0/model_final_checkpoint.model
...
OUT=/home/share/hzau/home/liuyangfan/swine-CT-article/data/nnunetv1/v1_comparison_predictions/swinunetr__seed20260521
mkdir -p "${OUT}"
cd "/home/share/hzau/home/liuyangfan/swine-CT-article"
echo "=== predict swinunetr seed=20260521 ==="
"${NNUNETV1_PYTHON}" -m framework.predict \
    ...
    --output-folder "${OUT}" \
    --step-size 0.5
echo "=== predict_swinunetr_seed20260521 DONE (exit $?) ==="
