#!/usr/bin/env bash
#DSUB -n predict_mednext_s_seed20260522
#DSUB -N 1
#DSUB -A root.hzau
#DSUB -R "cpu=8;mem=48000;gpu=1"
#DSUB -pn '!whshare-agent-174'
#DSUB -oo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/predict/predict_mednext_s_seed20260522.out
#DSUB -eo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/predict/predict_mednext_s_seed20260522.err
set -euo pipefail
...
CKPT=/home/share/hzau/home/liuyangfan/swine-CT-article/data/nnunetv1/v1_comparison/mednext_s__seed20260522/fold_0/model_final_checkpoint.model
...
OUT=/home/share/hzau/home/liuyangfan/swine-CT-article/data/nnunetv1/v1_comparison_predictions/mednext_s__seed20260522
mkdir -p "${OUT}"
cd "/home/share/hzau/home/liuyangfan/swine-CT-article"
echo "=== predict mednext_s seed=20260522 ==="
"${NNUNETV1_PYTHON}" -m framework.predict \
    --network mednext_s --seed 20260522 \
    --checkpoint "${CKPT}" \
    --input-folder "${INPUT}" \
    --output-folder "${OUT}" \
    --step-size 0.5
echo "=== predict_mednext_s_seed20260522 DONE (exit $?) ==="
