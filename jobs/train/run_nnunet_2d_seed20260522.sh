#!/usr/bin/env bash
#DSUB -n train_nnunet_2d_seed20260522
#DSUB -N 1
#DSUB -A root.hzau
#DSUB -R "cpu=16;mem=64000;gpu=1"
#DSUB -pn '!whshare-agent-174'
#DSUB -oo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/train/train_nnunet_2d_seed20260522.out
#DSUB -eo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/train/train_nnunet_2d_seed20260522.err
set -euo pipefail
...
echo "=== train nnunet_2d seed=20260522 -> ${RESULTS}/nnunet_2d__seed20260522 ==="
"${NNUNETV1_PYTHON}" \
    /home/share/hzau/home/liuyangfan/swine_ct_autonomous_discovery/scripts/nnunetv1_compat/train_paca_deterministic.py \
    --root "${ROOT}/seed20260522" \
    --run-name nnunet_2d__seed20260522 \
    --base-seed 20260522 \
    --task-id 601 \
    --network 2d \
    ...
    --results-folder "${RESULTS}/nnunet_2d__seed20260522" \
    --fp16 --unpack-data \
    --checkpoint-policy final-best
echo "=== train_nnunet_2d_seed20260522 DONE (exit $?) ==="
