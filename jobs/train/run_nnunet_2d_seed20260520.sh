#!/usr/bin/env bash
#DSUB -n train_nnunet_2d_seed20260520
#DSUB -N 1
#DSUB -A root.hzau
#DSUB -R "cpu=16;mem=64000;gpu=1"
#DSUB -pn '!whshare-agent-174'
#DSUB -oo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/train/train_nnunet_2d_seed20260520.out
#DSUB -eo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/train/train_nnunet_2d_seed20260520.err
set -euo pipefail
...
echo "=== train nnunet_2d seed=20260520 -> ${RESULTS}/nnunet_2d__seed20260520 ==="
"${NNUNETV1_PYTHON}" \
    /home/share/hzau/home/liuyangfan/swine_ct_autonomous_discovery/scripts/nnunetv1_compat/train_paca_deterministic.py \
    --root "${ROOT}/seed20260520" \
    --run-name nnunet_2d__seed20260520 \
    --base-seed 20260520 \
    --task-id 601 \
    --network 2d \
    ...
    --results-folder "${RESULTS}/nnunet_2d__seed20260520" \
    --fp16 --unpack-data \
    --checkpoint-policy final-best
echo "=== train_nnunet_2d_seed20260520 DONE (exit $?) ==="
