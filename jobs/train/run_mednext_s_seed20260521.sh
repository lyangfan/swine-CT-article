#!/usr/bin/env bash
#DSUB -n train_mednext_s_seed20260521
#DSUB -N 1
#DSUB -A root.hzau
#DSUB -R "cpu=16;mem=64000;gpu=1"
#DSUB -pn '!whshare-agent-174'
#DSUB -oo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/train/train_mednext_s_seed20260521.out
#DSUB -eo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/train/train_mednext_s_seed20260521.err
set -euo pipefail
...
OUT=/home/share/hzau/home/liuyangfan/swine-CT-article/data/nnunetv1/v1_comparison/mednext_s__seed20260521
mkdir -p "${OUT}"
cd "/home/share/hzau/home/liuyangfan/swine-CT-article"
echo "=== train mednext_s seed=20260521 -> ${OUT} ==="
"${NNUNETV1_PYTHON}" -m framework.train \
    ...
    --task-id 601 --fold 0 \
    --output-folder "${OUT}"
echo "=== train_mednext_s_seed20260521 DONE (exit $?) ==="
