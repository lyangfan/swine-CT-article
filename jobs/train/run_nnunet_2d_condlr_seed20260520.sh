#!/usr/bin/env bash
#DSUB -n train_nnunet_2d_condlr_seed20260520
#DSUB -N 1
#DSUB -A root.hzau
#DSUB -R "cpu=16;mem=64000;gpu=1"
#DSUB -pn '!whshare-agent-174'
#DSUB -oo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/train/train_nnunet_2d_condlr_seed20260520.out
#DSUB -eo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/train/train_nnunet_2d_condlr_seed20260520.err
set -euo pipefail
...
OUT=/home/share/hzau/home/liuyangfan/swine-CT-article/data/nnunetv1/v1_comparison/nnunet_2d__condlr_seed20260520
mkdir -p "${OUT}"
cd "/home/share/hzau/home/liuyangfan/swine-CT-article"
echo "=== train nnunet_2d condlr seed=20260520 axis=1 -> ${OUT} ==="
"${NNUNETV1_PYTHON}" -m framework.train \
    ...
    --output-folder "${OUT}"
echo "=== train_nnunet_2d_condlr_seed20260520 DONE (exit $?) ==="
