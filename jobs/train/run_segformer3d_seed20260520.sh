#!/usr/bin/env bash
#DSUB -n train_segformer3d_seed20260520
#DSUB -N 1
#DSUB -A root.hzau
#DSUB -R "cpu=16;mem=64000;gpu=1"
#DSUB -pn '!whshare-agent-174'
#DSUB -oo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/train/train_segformer3d_seed20260520.out
#DSUB -eo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/train/train_segformer3d_seed20260520.err
set -euo pipefail
...
OUT=/home/share/hzau/home/liuyangfan/swine-CT-article/data/nnunetv1/v1_comparison/segformer3d__seed20260520
mkdir -p "${OUT}"
cd "/home/share/hzau/home/liuyangfan/swine-CT-article"
echo "=== train segformer3d seed=20260520 -> ${OUT} ==="
"${NNUNETV1_PYTHON}" -m framework.train \
    --network segformer3d \
    --seed 20260520 \
    --config configs/segformer3d.yaml \
    --task-id 601 --fold 0 \
    --output-folder "${OUT}"
echo "=== train_segformer3d_seed20260520 DONE (exit $?) ==="
