#!/usr/bin/env bash
#DSUB -n eval_swinunetr_condlr_seed20260520
#DSUB -N 1
#DSUB -A root.hzau
#DSUB -R "cpu=4;mem=16000;gpu=0"
#DSUB -pn '!whshare-agent-174'
#DSUB -oo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/eval_swinunetr_condlr_seed20260520.out
#DSUB -eo /home/share/hzau/home/liuyangfan/swine-CT-article/jobs/eval_swinunetr_condlr_seed20260520.err
set -euo pipefail
...
echo "=== eval swinunetr condlr seed=20260520 ==="
${NNUNETV1_PYTHON} -m evaluation.run_eval \
    --predictions /home/share/hzau/home/liuyangfan/swine-CT-article/data/nnunetv1/v1_comparison_predictions/swinunetr__condlr_seed20260520 \
    ...
    --seed 20260520 \
    --output-csv /home/share/hzau/home/liuyangfan/swine-CT-article/evaluation/results/swinunetr_condlr_seed20260520_per_case.csv
echo "=== DONE (exit $?) ==="
